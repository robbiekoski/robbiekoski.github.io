...
1. Create a **Proxy Host** that will direct the subdomain to the appropriate service. Some services may    For example:
  - `Domain Names` - the full domain name including subdomain for the service
  - `Scheme` - https
